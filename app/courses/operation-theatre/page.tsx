...
const OperationTheatrePage = () => {
  ...
  const careerPaths = [
    "Operation Theatre Technician", "Surgical Assistant",
    "Anesthesia Technician", "Sterile Processing Technician",
    "Surgical First Assistant", "Endoscopy Technician",
    "Emergency Room Technician", "Day Surgery Unit Technician"
  ];

  const uniquePoints = [
    {
      title: "OT Simulation Lab",
      desc: "Train in fully equipped operation theatre simulation environments.",
      icon: <MedicineBoxOutlined style={{ color: '#ffc107', fontSize: '24px' }} />
    },
    {
      title: "Surgical Excellence",
      desc: "Master sterile techniques and surgical instrument management.",
      icon: <ThunderboltOutlined style={{ color: '#ffc107', fontSize: '24px' }} />
    },
    {
      title: "Hospital Partnerships",
      desc: "Hands-on training in leading hospitals and surgical centers.",
        ...
        <div className="hero-section" style={{ 
          ...
          <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 20px' }}>
            ...
            <Paragraph className="hero-description" style={{ 
              ...
              Become an essential part of surgical teams with expertise in operation theatre management and surgical assistance.
            </Paragraph>
          </div>
        </div>
